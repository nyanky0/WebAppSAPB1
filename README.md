...
- **2026-09-01 17:36**: feat: validate and test SAP Service Layer login API before saving/updating user, block save on failure, and display sanitized JSON payload (CompanyDB + UserName)
