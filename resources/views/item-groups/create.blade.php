                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="default_uom_group" class="block text-sm font-medium leading-6 text-gray-900">Default UoM Group</label>
                            <div class="mt-2">
                                <input type="text" name="default_uom_group" id="default_uom_group" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. Manual or Group Code">
                            </div>
                        </div>

                        <div class="sm:col-span-3">
                            <label for="default_uom" class="block text-sm font-medium leading-6 text-gray-900">Default UoM</label>
                            <div class="mt-2">
                                <input type="text" name="default_uom" id="default_uom" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. PCS, BOX">
                            </div>
                        </div>
